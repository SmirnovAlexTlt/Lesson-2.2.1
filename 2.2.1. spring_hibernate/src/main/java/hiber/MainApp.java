...
//      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("kea",45)));
      ...
      for (User user : users) {
         ...
         System.out.println("Car = "+ user.getCarDetails().getModel() + ", " + user.getCarDetails().getSeries());
         System.out.println();
      }

      System.out.println(userService.getUser("ford",12).getFirstName());
